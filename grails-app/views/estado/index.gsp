		...
		<div id="list-estado" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombreEstado" title="${message(code: 'estado.nombreEstado.label', default: 'Nombre Estado')}" />
				...
				<g:each in="${estadoInstanceList}" status="i" var="estadoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${estadoInstance.id}">${fieldValue(bean: estadoInstance, field: "nombreEstado")}</g:link></td>
