	...
	<body>
		...
		<div id="show-estado" class="content scaffold-show" role="main">
			...
			<ol class="property-list estado">
				...
				<g:if test="${estadoInstance?.nombreEstado}">
				<li class="fieldcontain">
					<span id="nombreEstado-label" class="property-label"><g:message code="estado.nombreEstado.label" default="Nombre Estado" /></span>
					
						<span class="property-value" aria-labelledby="nombreEstado-label"><g:fieldValue bean="${estadoInstance}" field="nombreEstado"/></span>
