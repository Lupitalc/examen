	...
	<body>
		...
		<div id="show-municipio" class="content scaffold-show" role="main">
			...
			<ol class="property-list municipio">
				...
				<g:if test="${municipioInstance?.nombreMunicipio}">
				<li class="fieldcontain">
					<span id="nombreMunicipio-label" class="property-label"><g:message code="municipio.nombreMunicipio.label" default="Nombre Municipio" /></span>
					
						<span class="property-value" aria-labelledby="nombreMunicipio-label"><g:fieldValue bean="${municipioInstance}" field="nombreMunicipio"/></span>
