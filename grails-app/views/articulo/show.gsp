    ...
    <g:if test="${flash.message}">
        ...
        <g:if test="${articuloInstance?.descripcionArticulo}">
            <li class="fieldcontain">
                <span id="descripcionArticulo-label" class="property-label"><g:message code="pais.nombrePais.label" default="Articulo" /></span>

                <span class="property-value" aria-labelledby="descripcionArticulo-label">
                    <g:fieldValue bean="${articuloInstance}" field="descripcionArticulo"/></span>
