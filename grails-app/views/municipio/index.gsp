		...
		<div id="list-municipio" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombreMunicipio" title="${message(code: 'municipio.nombreMunicipio.label', default: 'Nombre Municipio')}" />
				...
				<g:each in="${municipioInstanceList}" status="i" var="municipioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${municipioInstance.id}">${fieldValue(bean: municipioInstance, field: "nombreMunicipio")}</g:link></td>
